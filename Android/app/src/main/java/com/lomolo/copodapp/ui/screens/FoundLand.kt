...
import com.lomolo.copodapp.state.viewmodels.GettingTitleDetails
...
fun FoundLandScreen(
    ...
    onGoBack: () -> Unit,
    viewModel: LandTitleDetailsViewModel,
) {
    val titleDetails by viewModel.titleDetails.collectAsState()
    ...
    Scaffold(topBar = {
        ...
        Surface(
            ...
            when (viewModel.gettingTitleDetails) {
                GettingTitleDetails.Success -> Column(
                    modifier = Modifier
                        .fillMaxSize()
                ...
                GettingTitleDetails.Loading -> LoadingScreen()
            }
        }
    }
}